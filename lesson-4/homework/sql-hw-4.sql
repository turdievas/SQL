...
/*9.Use SELECT DISTINCT on two columns (Category and ProductName) 
in the Products table. */
select distinct category, productName from products --10.ordering by ProductName syntax will come in the above line
order by productname desc

--Medium-Level Tasks (10)
/*11.Write a query to select the top 10 products from the Products 
table, ordered by Price DESC.
 */
...
--17.Write a query that filters the Products table for ProductName values containing the letter 'e' using LIK
...
select * from employees where Age<30 and (DepartmentName='HR' or DepartmentName='IT')
