...
/* 2.Write a query that uses an alias to rename the Customers table
as Client for easier reference.*/
SELECT CustomerID,
    FirstName ,
    LastName,
    Email ,
    ...
    State ,
    PostalCode,
    Country   from Customers as Client
